        ...
        <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900 overflow-y-auto" data-print>
          <style>{`
            @media print {
              ...
              [data-print] { position: static !important; inset: auto !important; background: white !important; color: black !important; width: 100% !important; max-width: 100% !important; overflow: visible !important; z-index: auto !important; }
              ...
              [data-print] .recharts-surface { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
              [data-print] .recharts-wrapper { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
              [data-print] svg { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
